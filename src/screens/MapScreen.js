            ...
            <View style={styles.mainViewStyle}>
                ...
                <View style={styles.myViewStyle}>
                    ...
                    <View style={styles.iconsViewStyle}>
                        <TouchableOpacity onPress={() => { this.props.navigation.navigate('Search', { from: "where", whereText: this.state.whereText, dropText: this.state.dropText, old: this.state.passData, onWhere: (data) => this.setState({ whereData: data }) }); }} style={styles.contentStyle}>
