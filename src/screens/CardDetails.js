        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
          <View style={{ flex: 1, flexDirection: 'column' }}>
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              ...
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{Currency} {parseFloat(this.state.payDetails.amount).toFixed(2)}</Text>
            </View>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: '#000', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{languageJSON.promo_discount}</Text>
              <Text style={{ color: '#BB1E1E', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>- {Currency} {this.state.payDetails ? this.state.payDetails.discount ? parseFloat(this.state.payDetails.discount).toFixed(2) : '0.00' : '0.00'}</Text>
            </View>
            {this.state.useWalletCash == true ?
              <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
                ...
                <Text style={{ color: '#BB1E1E', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>- {Currency} {this.state.usedWalletAmmount ? parseFloat(this.state.usedWalletAmmount).toFixed(2) : '0.00'}</Text>
              </View> : null}
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              ...
              <Text style={{ color: '#018509', textAlign: 'left', lineHeight: 45, fontSize: 18, fontWeight: '500' }}>{Currency} {this.state.payDetails.payableAmmount ? parseFloat(this.state.payDetails.payableAmmount).toFixed(2) : 0.00}</Text>
            </View>
          </View>
